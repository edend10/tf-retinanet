...
def make_training_config(args):
    ...
    if args.tensorboard:
        ...
        config["callbacks"]["tensorboard_path"] = args.tensorboard_path
    if args.earlystopping:
        config["callbacks"]["earlystopping"] = args.earlystopping
        config["callbacks"]["earlystopping_patience"] = args.earlystopping_patience
    if args.reduceLR:
